...
import Atardecer from "../../assets/images/exteriores/atardecer_dalam.jpg";
...
const rooms = [
  {
    ...
    amenities: [
      { icon: "fa-solid fa-wifi", title: "Wi-Fi" },
      { icon: "fa-solid fa-snowflake", title: "Aire" },
      { icon: "fa-solid fa-mug-hot", title: "Desayuno" },
    ],
  },
  {
    img: roomPatzcuaro,
    ...
    amenities: [
      ...
      { icon: "fa-solid fa-snowflake", title: "Aire" },
      { icon: "fa-solid fa-mug-hot", title: "Desayuno" },
      { icon: "fa-solid fa-bath", title: "Tina" },
    ],
  },
  {
    img: roomParacho,
...
const services = [
  {
    ...
    text: "Diseño boutique con máximo confort y detalles artesanales únicos.",
  },
  {
    icon: "fa-solid fa-tree",
    title: "Entorno Natural",
    text: "Tranquilidad y conexión profunda con la naturaleza michoacana.",
  },
  {
    icon: "fa-solid fa-concierge-bell",
    title: "Atención Personalizada",
    text: "Hospitalidad auténtica michoacana con calidez y servicio de lujo.",
  },
  {
    icon: "fa-solid fa-utensils",
    title: "Desayuno Regional",
    text: "Sabores tradicionales que despiertan los sentidos cada mañana.",
  },
];
...
const heroSlides = [
  { src: Atardecer, alt: "Atardecer en Quinta Dalam" },
...
export default function Home() {
  ...
  // Funciones para navegación manual que te faltaron
  ...
  return (
    ...
    >
      ...
      <section className="hero" aria-label="Portada principal">
        ...
        {/* CONTROLES DEL CARRUSEL AÑADIDOS */}
        <button
